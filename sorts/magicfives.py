...
def partition(A, p, r): #funkcja partition która za pivota bierze elemenet pod indeksem p, w tym miejscu zawsze znajdzie się mediana median
    i = p
...
def createmed(T,p,r): #funkcja rekurencyjna tworząca medianę median i umieszcza tę medianę ostatecznie na indeksie p
    ...
    iter = n // 5
    if p < r:
        for i in range(iter): #zbierz mediany z pełnych piątek i swapuj je z kolejnymi indeksami począwszy od p, p+1, ...
